package com.zgf.frescotestapp.utils;
...
import com.zgf.frescotestapp.R;
...
public class FrescoUtils {
    ...
    public static void loadImage(Context context, String picUrl, final SimpleDraweeView simpleDraweeView, int topLeft, int topRight, int bottomLeft, int bottomRight) {
        ...
        GenericDraweeHierarchy hierarchy = builder
                ...
                .setRetryImage(R.drawable.ic_launcher)
     ...
     * @param mSimpleDraweeView
     */
    public static void loadImageGifAuto(String url, SimpleDraweeView mSimpleDraweeView) {
